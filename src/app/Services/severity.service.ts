...
export class SeverityService {
  ...
  public auditHealthCheck() {
    return this.http.get(Microservices['severity'] + '/health-check', {
      responseType: 'text',
    });
  }

  public benchHealthCheck() {
    return this.http.get(Microservices['benchmark'] + '/health-check', {
      responseType: 'text',
    });
  }
  ...
  //     // this.http
  //     //   .post<AuditResponse>(
  //     //     Microservices['severity'] + '/projectexecutionstatus',
  //     //     {
  ...
  //         auditDetail: {
  //           auditType: this.checklistService.getAuditType(),
  //           noOfNos: this.checklistService.noOfNos,
  //         },
  //       }
  //     );
  //   }
  ...
  public executionStatus(): Observable<AuditResponse> {
    return this.http.post<AuditResponse>(
      Microservices['severity'] + '/project-execution-status',
      {
        projectName: this.securityService.getProjectDetails().ProjectName,
        managerName: this.securityService.getProjectDetails().Name,
        auditDetail: {
